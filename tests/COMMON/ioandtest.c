...
static PRIMME_REAL primme_dot_real(SCALAR *x, SCALAR *y, primme_params *primme) {
   PRIMME_REAL aux, aux0;
   int n = 1;
   int ierr;
...
static PRIMME_REAL primme_svds_dot_real(SCALAR *x, SCALAR *y, int trans, primme_svds_params *primme) {
   PRIMME_REAL aux, aux0;
   int n = 1;
   int ierr;
